...
exports.PDF20 = exports.PDF17 = exports.CipherTransform = exports.CipherTransformFactory = exports.calculateSHA512 = exports.calculateSHA384 = exports.calculateSHA256 = exports.calculateMD5 = exports.ARCFourCipher = exports.AES256Cipher = exports.AES128Cipher = exports.getNodeCrypto = exports.encodeRevision6Password = void 0;
...
const encodeRevision6Password = (password = '') => {
    ...
    return (0, strings_1.stringAsByteArray)(encoded).subarray(0, Math.min(127, encoded.length));
};
exports.encodeRevision6Password = encodeRevision6Password;
class ARCFourCipher {
    constructor(key) {
        this.a = 0;
        this.b = 0;
...
exports.getNodeCrypto = (() => {
    let resolved = null;
    const hex = (bytes) => Array.from(bytes).map(strings_1.toHexString).join('');
    return () => {
        var _a, _b;
        if (resolved !== null)
            return resolved;
        try {
            const module = (_b = (_a = globalThis.process) === null || _a === void 0 ? void 0 : _a.getBuiltinModule) === null || _b === void 0 ? void 0 : _b.call(_a, 'crypto');
            if (typeof (module === null || module === void 0 ? void 0 : module.createHash) !== 'function' ||
                typeof (module === null || module === void 0 ? void 0 : module.createCipheriv) !== 'function') {
                return (resolved = undefined);
            }
            const primitives = {
                hash: (algorithm, data) => new Uint8Array(module.createHash(algorithm).update(data).digest()),
            ...
            const ok = hex(primitives.hash('sha256', empty)) ===
...
class PDF20 {
    calculatePDF20Hash(password, input, userBytes) {
        ...
        while (i < 64 || e[e.length - 1] > i - 32) {
            ...
            k = hash(remainder === 0 ? 'sha256' : remainder === 1 ? 'sha384' : 'sha512', e);
            i++;
        }
...
class CipherTransformFactory {
    constructor(dict, fileIdBytes, password) {
        ...
        if (!keyLength) {
            ...
            if (algorithm <= 3) {
                ...
                const cfDict = dict.lookup(PDFName_1.default.of('CF'));
                const streamCryptoName = dict.lookup(PDFName_1.default.of('StmF'));
                if (cfDict instanceof PDFDict_1.default && streamCryptoName instanceof PDFName_1.default) {
                    cfDict.suppressEncryption = true;
                    const handlerDict = cfDict.lookup(streamCryptoName);
                    let keyLen = null;
                    if (handlerDict) {
                        keyLen = handlerDict.lookup(PDFName_1.default.of('Length'));
                    }
        ...
        if (password) {
            passwordBytes =
                revision === 6
                    ? (0, exports.encodeRevision6Password)(password)
                    : (0, strings_1.stringAsByteArray)(password);
        }
        let encryptionKey;
        if (algorithm !== 5) {
        ...
        if (algorithm >= 4) {
            const cf = dict.lookup(PDFName_1.default.of('CF'));
            ...
            this.cf = cf;
            this.stmf =
                dict.lookup(PDFName_1.default.of('StmF')) || this.identityName;
            this.strf =
                dict.lookup(PDFName_1.default.of('StrF')) || this.identityName;
            this.eff = dict.lookup(PDFName_1.default.of('EFF')) || this.stmf;
        }
    }
    ...
    buildCipherConstructor(cf, name, num, gen, key) {
        ...
        const cryptFilter = cf.lookup(name);
        let cfm;
        if (cryptFilter !== null && cryptFilter !== undefined) {
            cfm = cryptFilter.lookup(PDFName_1.default.of('CFM'));
        }
