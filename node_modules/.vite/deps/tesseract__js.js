import { i as __require, t as __commonJSMin } from "./rolldown-runtime-CEgmsyvS.js";
...
var require_getEnvironment = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = (key) => {
		...
		else if (isElectron()) env.type = "electron";
...
//#endregion
//#region node_modules/tesseract.js/src/utils/circularize.js
var require_circularize = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	...
	*/
	var loadImage = async (image) => {
		...
		if (typeof image === "string") {
			if (/data:image\/([a-zA-Z]*);base64,([^"]*)/.test(image)) data = atob(image.split(",")[1]).split("").map((c) => c.charCodeAt(0));
	...
	module.exports = async (langs = "eng", oem = OEM.LSTM_ONLY, _options = {}, config = {}) => {
		...
		onMessage(worker, ({ workerId, jobId, status, action, data }) => {
			...
			if (status === "resolve") {
				...
				let d = data;
				if (action === "recognize") d = circularize(data);
				else if (action === "getPDF") d = Array.from({
					...data,
